...
EpiTrxInfo _$EpiTrxInfoFromJson(Map<String, dynamic> json) {
  return EpiTrxInfo(
...
Map<String, dynamic> _$EpiTrxInfoToJson(EpiTrxInfo instance) => <String, dynamic>{
