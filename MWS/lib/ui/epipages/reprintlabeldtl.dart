...
class ReprintLabelDtl extends StatefulWidget {
  final EpiReprintInfo reprintList;
  ReprintLabelDtl(this.reprintList);

  ReprintLabelDtlState createState() => ReprintLabelDtlState();
}

class ReprintLabelDtlState extends State<ReprintLabelDtl> {
  ...
  void initState() {
    ...
    txtPartNo = TextEditingController(text: widget.reprintList.partNum);
    txtPartDesc = TextEditingController(text: widget.reprintList.partDesc);
    txtBatchNo = TextEditingController(text: widget.reprintList.batch);
  }
                  ...
                  children: <Widget>[
                    Expanded(
                      child: ListTile(
                        title: TextFormField(
                          decoration:
                              InputDecoration(labelText: 'Part Description'),
                          obscureText: false,
                          keyboardType: TextInputType.text,
                          autocorrect: false,
                ...
                Row(
                  children: <Widget>[
                    Expanded(
                      child: ListTile(
                        title: TextFormField(
                          decoration: InputDecoration(labelText: 'Seq'),
                          obscureText: false,
                          keyboardType: TextInputType.number,
                          autocorrect: false,
                          controller: txtSeqNo,
  ...
  Future submitData() async {
    ...
    _result = await postRePrintLabel(
      widget.reprintList.sysDate ?? "",
      widget.reprintList.tranNum.toString(),
      txtPartNo.text,
      widget.reprintList.tranType ?? "",
      "",
      "",
      "",
      "",
