...
class ReturnAssembly extends StatefulWidget {
  ReturnAssembly();

  ReturnAssemblyState createState() => ReturnAssemblyState();
}

class ReturnAssemblyState extends State<ReturnAssembly> {
  ...
  Future submitData() async {
    ...
    _result = await postReturnAssembly(
        txtJobNo.text,
        txtAsmNo.text,
        txtPartNo.text,
        txtIUM.text,
    ...
    if (_result[0] == false) {
      showAlertPopup(
          context, 'Error', 'Process Return Assembly : ' + _result[1]);
      return;
    }
